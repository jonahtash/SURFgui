...
def run_csv_output(pdf_in, csv_out):
    ...
    os.system("java -Xmx10g -jar ./wrappers/conda/sp.jar "+pdf_in+" -o "+json_path)
    print("Generating CSV tables ..")
    run_json_folder(json_path,'./wrappers/conda/exclude.csv','./wrappers/conda/chars.csv',csv_out.strip('.csv')+"bkup.csv",csv_out+'.csv')
